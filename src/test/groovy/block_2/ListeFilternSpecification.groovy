...
class ListeFilternSpecification extends Specification {
    ...
    def "Aufgabe Bestimmte Zahlen auswählen, Duplikate entfernen und sortieren"() {
        given:
        def numbers = [6, 2, 4, 2, 6, 1, 5]
        def allowed = [4, 2, 6]

        expect:
        ListFilter.selectedUniqueNumbers(numbers, allowed) == [2, 4, 6]
    }
}